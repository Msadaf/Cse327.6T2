...
;        setContentView(R.layout.activity_verify_phone_);
        ...
        getIntent().getStringArrayExtra("Phonenumber");
        ...
        findViewById(R.id.buttonLogIn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                verifyCode(code); /* if the validation succeed will display the progress bar, and call the verify code*/
    ...
    private void LoginWithCredential(PhoneAuthCredential credential) {
        mAuth.LogInWithCredential(credential)
