...
public class ScanningQrCode extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  btnClickPicture = (Button)findViewById(R.id.btnClickPicture);
        this.imgCapture = findViewById(R.id.imgCapture);
  //       btnClickPicture.setOnClickListener(this);

       // btnAnalyze =(Button) findViewById(R.id.btnAnalyse);
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public int getRotationCompensation(String cameraId, ScanningQrCode activity, ScanningQrCode context)
            throws CameraAccessException {
        // Get the device's current rotation relative to its "native" orientation.
        // Then, from the ORIENTATIONS table, look up the angle the image must be
        // rotated to compensate for the device's rotation.
        int deviceRotation = ((Activity)context).getWindowManager().getDefaultDisplay().getRotation();
